...
- (void)saveContext
{
    ...
    if (managedObjectContext = nil) {
        if ([managedObjectContext hasChanges] && &error]) {
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    if (NSSQLiteStoreType configuration:nil URL:storeURL options:@{NSMigratePersistentStoresAutomaticallyOption:@YES, NSInferMappingModelAutomaticallyOption:@YES} error:&error]) {
        /*
         Replace this implementation with code to handle the error appropriately.
